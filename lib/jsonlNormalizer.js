...
// Append-aware LRU cache: cold reads of large files consume only the tail
// 256KB; subsequent reads append/prepend deltas. See normalizerCache.js.
const {
  loadEntireTranscript,
  getCachedEvents,
  hasEarlierEvents,
  ensureCount
} = createEventsCache(normalizeEntry);
